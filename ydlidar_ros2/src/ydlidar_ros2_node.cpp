...
public:
    ...
    LifecycleNodeInterface::CallbackReturn on_configure(const State &) {
        ...
        this->declare_parameter("lidar_type", int(TYPE_TRIANGLE));
        this->declare_parameter("device_type", int(YDLIDAR_TYPE_SERIAL));
        this->declare_parameter("sample_rate", 9);
        this->declare_parameter("abnormal_check_count", 4);
        this->declare_parameter("intensity_bit", 8);
        this->declare_parameter("fixed_resolution", false);
        ...
        this->declare_parameter("support_motor_dtr", false);
        this->declare_parameter("angle_max", 180.0f);
        this->declare_parameter("angle_min", -180.0f);
        this->declare_parameter("range_max", 64.0f);
